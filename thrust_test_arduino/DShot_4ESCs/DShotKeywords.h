...
#define DIGITAL_CMD_BEEP1 \
  1  // Wait at least length of beep (260ms) before next command
#define DIGITAL_CMD_BEEP2 \
  2  // Wait at least length of beep (260ms) before next command
#define DIGITAL_CMD_BEEP3 \
  3  // Wait at least length of beep (280ms) before next command
#define DIGITAL_CMD_BEEP4 \
  4  // Wait at least length of beep (280ms) before next command
#define DIGITAL_CMD_BEEP5 \
  5  // Wait at least length of beep (1020ms) before next command
...
#define DIGITAL_CMD_SAVE_SETTINGS \
  12  // Need 6x, wait at least 35ms before next command
...
#define DIGITAL_CMD_SIGNAL_LINE_TELEMETRY_DISABLE \
  32  // Need 6x, no wait required. Disables commands 42 to 47
#define DIGITAL_CMD_SIGNAL_LINE_TELEMETRY_ENABLE \
  33  // Need 6x, no wait required. Enables commands 42 to 47
#define DIGITAL_CMD_SIGNAL_LINE_CONTINUOUS_ERPM_TELEMETRY \
  34  // Need 6x, no wait required. Enables commands 42 to 47, and sends erpm if
      // normal Dshot frame
#define DIGITAL_CMD_SIGNAL_LINE_CONTINUOUS_ERPM_PERIOD_TELEMETRY \
  35  // Need 6x, no wait required. Enables commands 42 to 47, and sends erpm
      // period if normal Dshot frame
