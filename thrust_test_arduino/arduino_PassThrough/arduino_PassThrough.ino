/*
  ...
  these names to connect any two serial ports on a board that has multiple
  ports.
...
void loop() {
  ...
  //  1)
  //    Serial1.write(Serial1.read());   // read it and send it out Serial1
  //    (pins 0 & 1)
  //  }
}
